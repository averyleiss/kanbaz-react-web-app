export default function Lab1() {
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-p-tag">
          ...
          <p>
            The paragraph tag is used to format vertical gaps between long pieces
  ...
  My favorite recipe (Grilled Cheese):
  <ol id="wd-your-favorite-recipe">
  <li>Spread mayonnaise on both sides of two slices of good bread.</li>
    <li>Heat up your nonstick skillet.</li>
    <li>Spray some PAM or add a small amount of butter to the pan.</li>
    <li>Place one piece of bread down.</li>
    <li>Layer multiple slices of your favorite cheese and place the other slice on top.</li>
    <li>Put the lid on the pan and let it cook for a few minutes, dont burn it!! </li>
    <li>Flip and cook the other side.</li>
    <li>Serve and enjoy!</li>
  </ol>
...
<ul id="wd-your-books">
<li>The Language of Flowers</li>
  <li>The Other Typist</li>
  <li>Gone Girl</li>
